...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-slate-100 bg-white/95 px-8 backdrop-blur-xl">
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <div className="relative">
          ...
          {menuOpen && (
            <div className="absolute right-0 top-[calc(100%+10px)] w-64 overflow-hidden rounded-2xl border border-slate-100 bg-white p-2 shadow-2xl shadow-slate-200/60">
