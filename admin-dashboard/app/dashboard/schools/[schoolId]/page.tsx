...
return (
  ...
  const isPrimarySchoolAdmin =
    isSchoolAdmin &&
    Boolean(
      (currentUser as any)?.is_primary_school_admin
    );
...
const schoolModules = [
    ...((isSuperAdmin || isSchoolAdmin) ? [{
      ...
      description: "View registered teachers and school administrators",
      icon: UserCog,
      href: `/dashboard/schools/${schoolId}/registered-users`,
    }] : []),

    ...((isSuperAdmin || isPrimarySchoolAdmin) ? [{
      title: "School Admins",
