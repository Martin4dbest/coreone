  ...
  async function loadData() {
    try {
      const [resultsRes, dashboardRes] = await Promise.all([
        api.get(`/cbt/schools/${schoolId}/results`),
